...
def main(args):
    ...
    output_dir = os.path.join(args.output_dir, f"{embedding_index_name}_topk_{args.top_k}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_samples", type=int, default=1e5, help="Maximum number of rows to sample from each table to construct embeddings.")
